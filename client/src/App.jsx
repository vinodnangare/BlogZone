  ...
  <div key={blog._id} className='border-2 border-black p-5 m-5'>
      <div className='flex justify-between items-center mb-4'>
       <h2 className='text-2xl font-bold static '>{blog.title}</h2>
         <p className='text-gray-800 border-2 border-amber-200 w-fit px-2 py-0 rounded-2xl bg-green-400 text-[10px]'>{blog.state}</p>
    </div>

  
    <p className='text-gray-600'>By: {blog.authorId.username} ({blog.authorId.email})</p>
    <div className='flex flex-row-reverse relative mt-0 '>
